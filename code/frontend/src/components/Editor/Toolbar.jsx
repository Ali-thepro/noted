...
const toolbarItems = [
  ...
  { action: 'italic', icon: <FaItalic />, tooltip: 'Italic', prefix: '_', suffix: '_' },
  ...
  { action: 'subscript', icon: <FaSubscript />, tooltip: 'Subscript', prefix: '~', suffix: '~' },
  { action: 'superscript', icon: <FaSuperscript />, tooltip: 'Superscript', prefix: '^', suffix: '^' },
  ...
  { action: 'code', icon: <FaCode />, tooltip: 'Code', prefix: '```\n', suffix: '\n```' },
