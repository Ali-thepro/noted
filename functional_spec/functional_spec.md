...
**Time Constraints**
The main challenge is the short time-frame available for development. A lot of features must be implemented within a short period. Getting proficient in Go and learning new tools might hinder development time.
